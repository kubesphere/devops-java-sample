pipeline {
  agent {
    ...
    environment {
        HARBOR_CREDENTIAL_ID = 'devops-harbo-id'
        GITLAB_CREDENTIAL_ID = 'devops-gitlab-id'
        KUBECONFIG_CREDENTIAL_ID = 'kubesphere-kubeconfig-id'
        REGISTRY = 'harbor.devops.jwis.cn:30280'
